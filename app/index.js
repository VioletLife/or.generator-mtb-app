...
var githubUserInfo = function (name, cb, log) {
  ...
  // });
  cb(JSON.parse(JSON.stringify(emptyGithubRes)));
};
...
var GeneratorGenerator = module.exports = yeoman.generators.Base.extend({
  ...
  prompting: {
    askFor: function () {
      ...
      var prompts = [{
        name: 'gitlabUser',
        message: 'Would you mind telling me your username on Gitlab?',
        default: 'someuser'
      }];
  ...
  writing: {
    ...
    app: function () {
      ...
      //cenan
      this.dest.mkdir('js');
      this.dest.mkdir('less');
      this.dest.mkdir('images');
      this.template('_index.html', 'index.html');

      this.src.copy('_main.less', 'less/main.less');
      this.src.copy('_main.js', 'js/main.js');
